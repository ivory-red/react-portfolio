          ...
          <ul className="edu__list">
            ...
            <li>
              <div className="list__area">
                <img src={uxui} alt="" />
                <div className="text__area">
                  <p className="text__title manrope">UX/UI 컨텐츠 디자인 및 퍼블리싱<br />교육 과정</p>
                  <p className="text nanum">Photoshop, Illustrator를 활용한 UX/UI 디자인 교육 및 <br />HTML, CSS, JavaScript를 활용한 퍼블리싱 교육 과정</p>
                </div>
              </div>
            </li>
            <li>
              <div className="list__area">
                <img src={coding} alt="" />
                <div className="text__area">
                  <p className="text__title manrope">JAVA 기반 웹 어플리케이션 개발<br />교육 과정</p>
                  <p className="text nanum">JAVA를 기반으로 한 웹 개발 양성 과정을 통해 웹 어플리케이션 <br />제작 능력을 습득 (JAVA, JSP Servlet, Spring, SQL, DB, Eclipse, Tomcat, Oracle)</p>
                </div>
              </div>
            </li>
          </ul>
